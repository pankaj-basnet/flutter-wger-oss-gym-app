...
class SearchLanguageDropdown extends StatelessWidget {
  final IngredientSearchLanguage selected;
  final ValueChanged<IngredientSearchLanguage> onChanged;
  ...
  Widget build(BuildContext context) {
    ...
    final items = <DropdownMenuItem<IngredientSearchLanguage>>[
      DropdownMenuItem(
    ...
    IngredientSearchLanguage? value = selected;
